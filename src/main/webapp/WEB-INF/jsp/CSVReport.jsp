   ...
   <body>
         ...
         <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  <li><a href="transactionReport">Customer Report</a></li>
      ...
      <div class="container">
       <h2>Rabobank Customer Transaction Report</h2><br/>
         <div id="records" ng-app="CSVParseApp" ng-controller="fileUploadCtrl">
            ...
            <span class="btn btn-primary btn-file"> Browse <input
               type="file" ngf-select="SelectFile($file)">
            </span> 
            <input
               type="button"  class="btn btn-primary" value="Upload" ng-click="Upload()"
               ng-disabled="!uploadStatus" />
            <hr />
            <table id="tblRecords" cellpadding="0" cellspacing="0" align="center"
               ng-show="IsVisible">
               <tr>
                  <th class ng-repeat="(header,value) in data[0]"
                     ng-click="sort(header)">{{header}} <span class="fa fa-sort"></span></th>
               </tr>
               <tbody>
