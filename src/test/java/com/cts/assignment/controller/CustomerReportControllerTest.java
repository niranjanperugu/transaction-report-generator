...
public class CustomerReportControllerTest {
	...
	@InjectMocks
	CustomerReportController customerReportController;
	...
	public void initiateTransaction_withInValidCsvData_WillProcessAndReturnReport() throws Exception {
		...
		when(transactionService.initiateTransaction(Matchers.<Records>any(), Matchers.<ModelAndView>any()))
	...
	@Test
	public void callIndex_willReturnIndexPath() throws Exception {

		assertNotNull(customerReportController.index());
	}

	@Test
	public void getCsvReport_willReturnReportPath() throws Exception {

		assertNotNull(customerReportController.getCsvReport());
	}

	@Test
	public void getTransactionReport_willReturnReportPath() throws Exception {
